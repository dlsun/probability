...
\begin{align*}
 P(\text{both boys}\ |\ \text{at least one boy}) &= \frac{P(\text{both boys} \text{ and } \text{at least one boy})}{P(\text{at least one boy})} \\ 
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/T-w-e7RNdgY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
