...
Bayes' Theorem is a way to convert probabilities of the form $P(B | A)$ into probabilities of the form $P(A | B)$. 
Don't let its simplicity deceive you; it is one of the most important and powerful results in all of probability and statistics. 
...
Unfortunately, we do not know $P(T)$, the probability of testing positive. However, we do know 
...
2. One application where Bayes' Theorem has been extremely successful is spam filtering. From historical data, the 
phrase "free money" is used in 10% of spam e-mails. That is, $P(\text{"free money"} | \text{spam}) = 0.1$. 
