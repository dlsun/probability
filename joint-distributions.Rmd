...
```{example, name="Chicken and the Egg"}
...
4. At a nuclear plant, radioactive particles hit a Geiger counter at a rate of 3.5 particles per second. 
Let $X$ be the number of particles detected in the first 2 seconds. Let $Y$ be the number of particles 
detected in the second after that (i.e., the third second). Find the joint p.m.f. of $X$ and $Y$.
(You may specify the joint p.m.f. as a table or a formula, whichever is more convenient for you.)
...
2. At a nuclear plant, radioactive particles hit a Geiger counter at a rate of 3.5 particles per second. 
