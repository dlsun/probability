...
We can save time using LOTUS. LOTUS allows to calculate the expected value of $X$ 
  without working out the p.d.f. of $X$. All we need is the p.d.f. of $I$, which we already know 
and is simple.
