...
```{r, echo=FALSE, engine='tikz', out.width='100%', fig.ext='png', fig.align='center', engine.opts = list(template = "tikz_template.tex")}
    ...
    \node[anchor=north,red] at (-.1, -1.7) {EV};
		...
		\foreach \x in {0, 3, ...,36}
			...
			\draw[ultra thick] (25, 7) -- (28, 7);
			\node[anchor=west] at (28, 7) {reds};
...
&= (35 - -\frac{2}{38})^2 \cdot \frac{37}{38} + (-1 - -\frac{2}{38})^2 \cdot \frac{1}{38} & \text{(LOTUS)}\\
&= 1196.38
\end{align*}

The payout from a bet on a single number, $Y$, has p.m.f.
\[ \begin{array}{r|cc} y & -1 & 35 \\ \hline f(y) & 37/38 & 1/38 \end{array}. \]
...
variance is in _squared_ units. That is, the variance of a bet on a single number is 1196.38 dollars _squared_. 
...
\[ \text{SD}[X] = \sqrt{\text{Var}[X]} = \sqrt{1196.38} = \$34.59. \]
...
number of arrivals you expect to see over an 5-minute period?
