...
\begin{equation} 
R_X[k] = C_X[k] + \mu_X^2 = \sigma^2\delta[k] + \mu^2.
...
It is stationary, so its autocorrelation function depends on $\tau = s - t$ only:
\begin{equation} 
...
5. Let $\{ X(t) \}$ be a random process with mean function 
