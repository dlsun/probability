...
contexts, not to convince you to believe or not to believe. I should mention that there have been 
...
is infinite in this case. However, the expected value can be infinite, even if 
the random variable is always finite.
...
First, let's work out the p.m.f. of the amount you win, $W$. Fill in the first 
...
you should be willing to pay? This is a famous problem in probability called the 
