...
```{r}
# R
1 - pnorm(22, mean=15.79, sd=3.87)
```
```{python}
# Python
1 - Normal(mean=15.79, sd=3.87).cdf(22)
```
...
These days, the wide availability of software for calculating exact binomial probabilities has 
diminished the importance of the normal approximation to the binomial. However, it is still an 
interesting application of the Central Limit Theorem.
...
$\bar X_n$ be your average net winnings over those $n$ bets. 
    ...
    distributed? Do a simulation to find out.
