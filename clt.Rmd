...
that the sample mean _converges_ to this expected value as $n \to\infty$.
...
is detected between 90 and 120 seconds? Calculate this probability in two ways:
    ...
    a. Make an argument for why _the time the 100th particle is detected_ approximately follows a 
...
1. A randomly selected apple from the Cal Poly Orchard weighs 4.9 oz. on average, with a standard deviation of 0.3 oz. However, the distribution of the weights of apples is unknown. 
    ...
    probability that a randomly selected apple weighs more than 5.0 oz?
    ...
    that the total weight of the apples in a crate exceeds 300 oz?
