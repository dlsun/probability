...
\[ P(S \geq 22) = 1 - P(S < 22) = 1 - P(S <= 22), \]
since the probability that $S$ equals 22 exactly is zero. However, in this case, 
we are using the normal distribution to approximate a discrete distribution, so
some have argued that we should plug in 21 or 21.5 instead.

In my opinion, details like these are irrelevant, since this is no longer a practical 
method of calculating probabilities. There is no reason to use 
