...
In the simulation above, $L$ is (not surprisingly) equally likely to take on
all values between 0 and 4. The distribution of $A$ is more interesting. It is much 
